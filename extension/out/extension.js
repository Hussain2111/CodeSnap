...
function activate(extensionContext) {
    exports.context = extensionContext;
    ...
    exports.context.subscriptions.push(startServerCmd, pairDeviceCmd, receiveCodeCmd);
...
async function pairDevice() {
    ...
    const port = vscode.workspace.getConfiguration('codesnap').get('port', 3001);
    ...
    if (currentPanel) {
        ...
        currentPanel = vscode.window.createWebviewPanel('codesnapPairing', 'Pair Device', vscode.ViewColumn.Beside, { enableScripts: true });
        // Handle panel disposal
        currentPanel.onDidDispose(() => {
            currentPanel = undefined;
        }, null, exports.context.subscriptions);
    }
...
function getWebviewContent(ip, port, qrCodeDataUrl) {
    return `<!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
